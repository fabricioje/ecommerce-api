...
RSpec.describe "Admin V1 Products as :admin", type: :request do
  ...
  context "GET /products" do
    ...
    context "without any params" do
      ...
      it_has_behavior_of 'pagination meta attributes', { page: 1, length: 10, total: 10, total_pages: 1 } do
    ...
    context "with search[name] param" do
      ...
      it_has_behavior_of 'pagination meta attributes', { page: 1, length: 10, total: 15, total_pages: 2 } do
    ...
    context "with pagination params" do
      ...
      it_has_behavior_of 'pagination meta attributes', { page: 2, length: 5, total: 10, total_pages: 2 } do
